...
@implementation Outcome2ViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
	...
	UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(12, 0, headerView.frame.size.width - 62, 44)];
	...
	label.text = [NSString stringWithFormat:@"%@", [self stringForTVC:g2m.outcome]];
