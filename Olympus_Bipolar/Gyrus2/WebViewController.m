...
//	fprintf(fp, " style=\"background-color: transparent\"><FONT COLOR=\"white\">\n");
	...
	fprintf(fp, "<H1><CENTER>%s</CENTER></H1>", [gyrus2model.articleTitle UTF8String]);
	...
	fprintf(fp, "<H3><CENTER>Reference</CENTER><H3>");
	fprintf(fp, "<FONT SIZE=-1><H2><CENTER>%s</CENTER></H2></FONT>", [[self stringForGeneral:gyrus2model.reference] UTF8String]);
	
	fprintf(fp, "<FONT COLOR=\"darkgold\">");
	
	fprintf(fp, "<H2><CENTER>Outcome / Comments</CENTER></H2>");
	fprintf(fp, "<H2><CENTER>%s</CENTER></H2>", [[self stringForGeneral:gyrus2model.outcomeOrComments] UTF8String]);
	
	fprintf(fp, "</FONT>");
	
	if ( ! [gyrus2model.abstract isEqualToString:@""] )
	{
		fprintf(fp, "<H3><CENTER>Abstract</CENTER></H3>");
		fprintf(fp, "<FONT SIZE=-1><H2>%s</H2></FONT>", [[self stringForGeneral:gyrus2model.abstract] UTF8String]);
	}
